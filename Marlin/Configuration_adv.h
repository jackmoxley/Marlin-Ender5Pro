...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN FAN1_PIN          // Set a custom pin for the controller fan FAN2_PIN
 ...
 */
#define E0_AUTO_FAN_PIN FAN2_PIN // FAN1_PIN
...
#if ANY(HAS_DISPLAY, DWIN_LCD_PROUI, DWIN_CREALITY_LCD_ENHANCED, DWIN_CREALITY_LCD_JYERSUI)
  #define SOUND_MENU_ITEM   // Add a mute option to the LCD menu
#endif

#if ANY(HAS_DISPLAY, DWIN_LCD_PROUI, DWIN_CREALITY_LCD_ENHANCED)
