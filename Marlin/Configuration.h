...
#define STRING_CONFIG_H_AUTHOR "(JMoxley, Ender-5 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ptah"
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 600, 600, 10, 60 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -48, -10.5, -2.1 }
